...
import BodyArticle1 from "./Views/Articles/Cialo/BodyArticle1";
import BodyArticle2 from "./Views/Articles/Cialo/BodyArticle2";
import BodyArticle3 from "./Views/Articles/Cialo/BodyArticle3";
import BodyArticle4 from "./Views/Articles/Cialo/BodyArticle4";
import BodyArticle5 from "./Views/Articles/Cialo/BodyArticle5";
import BodyArticle6 from "./Views/Articles/Cialo/BodyArticle6";
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        ...
        <Stack.Screen name="BodyArticle1" component={BodyArticle1} />
        <Stack.Screen name="BodyArticle2" component={BodyArticle2} />
        <Stack.Screen name="BodyArticle3" component={BodyArticle3} />
        <Stack.Screen name="BodyArticle4" component={BodyArticle4} />
        <Stack.Screen name="BodyArticle5" component={BodyArticle5} />
        <Stack.Screen name="BodyArticle6" component={BodyArticle6} />
