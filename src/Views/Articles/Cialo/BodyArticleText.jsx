export const articleTexts = [
  {
    ...
    MediumText: [
      ...
      "Zwracam Ci uwagę, że bierzesz za dużo na siebie. Nie dajesz już rady (choć pewnie bardzo byś chciał_).Być może czujsze też złość, ale nie chcesz jej okazać.",
    ],
